export const portfolioConfig = {
  ...
  // SEO Information
  seo: {
    ogImage: "https://zyth-portfolio.vercel.app/og-image.png",
    url: "https://zyth-portfolio.vercel.app/",
    twitterHandle: "@VyTrnTng5",
    keywords: [
      "Zyth",
      "zythdev",
      "portfolio",
    ...
    authors: [
      {
        name: "Zyth (based on original by Taqui Imam)",
        url: "https://github.com/zizi0209",
      },
      {
        name: "Taqui Imam",
  ...
  projects: [
    ...
    },
    {
      ...
      tags: ["Nextjs", "Typescript", "Tailwind CSS", "GSAP", "Shadcn Ui"],
